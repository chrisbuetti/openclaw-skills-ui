...
echo ""
echo "  5. Configure exec-approvals.json for per-agent isolation:"
echo "       python3 scripts/configure-exec-approvals.py"
echo "     Or non-interactively:"
echo "       python3 scripts/configure-exec-approvals.py --sandbox gabe --main main"
echo "     See docs/per-agent-exec-isolation.md for details."
echo ""
if [[ -z "$NPM_SKILLS_DIR" ]]; then
